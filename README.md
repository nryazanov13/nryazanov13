...
| **Ведущий тестировщик** в компании **ТриКолор**                    | 4 года     |
...
автотесты. Сейчас активно осваиваю **Selenium**, **REST‑Assured**, **JUnit 5**, **Allure**, **Maven/Gradle** и другие
...
| **Mobile‑тесты** | <https://github.com/nryazanov13/my_project_18_mobile> |

В каждом репозитории использованы лучшие практики: Page‑Object Model, Clean Architecture, CI/CD (GitHub Actions) и
...
- **Автоматизация:** Java + JUnit + Rest‑Assured + Selenide + Appium, построение масштабируемой тестовой инфраструктуры,
  интеграция в CI/CD (GitHub Actions, Jenkins).
...
- **Mentoring:** наставляю junior‑а, провожу парное программирование, делаю code‑review тестов, делюсь best‑practice.
...
| Канал        | Ссылка                                        |
|--------------|-----------------------------------------------|
| **Telegram** | <https://t.me/nikita_ryazanov>                |
| **Email**    | <nikita.ryazanov@example.com>                 |
| **LinkedIn** | <https://www.linkedin.com/in/nikita-ryazanov> |
| **GitHub**   | <https://github.com/dalekskaro>               |

---

## 📊 Статистика GitHub (только для любопытных)

<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=dalekskaro&show_icons=true&theme=radical" alt="GitHub Stats"/>
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=dalekskaro&theme=radical" alt="GitHub Streak"/>
</p>
...
- **Сократил время регрессионного цикла на 30 %** за счёт внедрения автоматизированных API‑тестов на Java +
  Rest‑Assured.
